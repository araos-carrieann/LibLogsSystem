...
public class AdminDashboard1 extends javax.swing.JFrame {
    ...
    public AdminDashboard1(String fname, String sfID) {
        this.sfID = sfID;
        initComponents();
    ...
    private void initComponents() {
        ...
        panelBorder9.add(btnFilter);
        btnFilter.setBounds(690, 70, 90, 23);
    ...
    private void btnUpdateFacultyAcctActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateFacultyAcctActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            UpdateAcct updateDialog = new UpdateAcct(new javax.swing.JFrame(), true);
            updateDialog.setFacultyData(id, facultyAdminID, email, firstName, lastName);
            updateDialog.setVisible(true);
            btnUpdateFacultyAcct.setEnabled(false);
